...
this.def["BitwiseOperations_U"] = {file: "BitwiseOperations_c.html",line:22,type:"var"};
this.def["BitwiseOperations_Y"] = {file: "BitwiseOperations_c.html",line:25,type:"var"};
this.def["BitwiseOperations.c:BitwiseOperations_M_"] = {file: "BitwiseOperations_c.html",line:28,type:"var"};
this.def["BitwiseOperations_M"] = {file: "BitwiseOperations_c.html",line:29,type:"var"};
this.def["BitwiseOperations_step"] = {file: "BitwiseOperations_c.html",line:32,type:"fcn"};
this.def["BitwiseOperations_initialize"] = {file: "BitwiseOperations_c.html",line:79,type:"fcn"};
this.def["BitwiseOperations_terminate"] = {file: "BitwiseOperations_c.html",line:85,type:"fcn"};
this.def["ExtU_BitwiseOperations_T"] = {file: "BitwiseOperations_h.html",line:40,type:"type"};
this.def["ExtY_BitwiseOperations_T"] = {file: "BitwiseOperations_h.html",line:50,type:"type"};
this.def["RT_MODEL_BitwiseOperations_T"] = {file: "BitwiseOperations_types_h.html",line:24,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["BitwiseOperations_c.html"] = "../BitwiseOperations.c";
	this.html2Root["BitwiseOperations_c.html"] = "BitwiseOperations_c.html";
	this.html2SrcPath["BitwiseOperations_h.html"] = "../BitwiseOperations.h";
	this.html2Root["BitwiseOperations_h.html"] = "BitwiseOperations_h.html";
	this.html2SrcPath["BitwiseOperations_private_h.html"] = "../BitwiseOperations_private.h";
	this.html2Root["BitwiseOperations_private_h.html"] = "BitwiseOperations_private_h.html";
	this.html2SrcPath["BitwiseOperations_types_h.html"] = "../BitwiseOperations_types.h";
	this.html2Root["BitwiseOperations_types_h.html"] = "BitwiseOperations_types_h.html";
...
var fileList = [
"ert_main_c.html","BitwiseOperations_c.html","BitwiseOperations_h.html","BitwiseOperations_private_h.html","BitwiseOperations_types_h.html","rtwtypes_h.html"];
